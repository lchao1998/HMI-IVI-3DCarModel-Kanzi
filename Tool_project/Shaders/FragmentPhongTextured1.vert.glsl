...
#if KANZI_SHADER_USE_BASECOLOR_TEXTURE || KANZI_SHADER_USE_NORMALMAP_TEXTURE
    texcoord = kzTextureCoordinate0 * TextureTiling + TextureOffset;
    smokecoord = kzTextureCoordinate0 * TextureTiling + TextureOffset + vec2(m_Time);
#endif
}
